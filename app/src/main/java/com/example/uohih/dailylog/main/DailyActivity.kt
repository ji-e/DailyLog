 ...
 * 리사이클뷰 아답터
 */
//class DailyRvAadapter(val mContext: Context, val dailyList: ArrayList<DBData>, val delete: Boolean) : RecyclerView.Adapter<DailyRvAadapter.Holder>() {
//
//    private val base = DLogBaseApplication()
...
//        fun bind(data: DBData, context: Context) {
